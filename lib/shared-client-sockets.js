  ...
  function completeRegistration (details, done) {
    ...
    */
    ...
    function done(err, data) {
      // regardless of error or not, save the pkiMap
    }
    ...
    */
    ...
    // consider treating this as an authentication error.
    if(clientPki.notificationPublicKey &&
       clientPki.notificationPublicKey !== credentials.key) {
      console.warn('Notification public key does not match for id: ' + details.identity);
    }
